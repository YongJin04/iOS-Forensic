...
def find_instagram_following_file(backup_path):
    """
    Instagram 팔로잉 정보가 포함된 파일을 찾는 함수
    
    Args:
        backup_path (str): iOS 백업 경로
        
    Returns:
        str or None: 해당 파일의 전체 경로 또는 찾지 못한 경우 None
    """
    ...
    search_results = helper.find_files_by_keyword("user_bootstrap/shared_bootstraps.plist")
